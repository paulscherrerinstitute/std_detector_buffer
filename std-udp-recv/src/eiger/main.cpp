...
int main(int argc, char* argv[])
{
  ...
  if ("eiger" != config.detector_type) {
    throw runtime_error("Config error. Expected detector type is eiger, but received " +
  ...
  RamBuffer frame_buffer(config.detector_name, sizeof(EigerFrame), FRAME_N_BYTES,
                         RAM_BUFFER_N_SLOTS);
