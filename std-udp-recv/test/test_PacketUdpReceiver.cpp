...
TEST(PacketUdpReceiver, simple_recv)
{
  ...
  ASSERT_TRUE(udp_receiver.receive(&recv_udp_buffer, BYTES_PER_PACKET));
  ...
  ASSERT_FALSE(udp_receiver.receive(&recv_udp_buffer, BYTES_PER_PACKET));
...
TEST(PacketUdpReceiver, false_recv)
{
  ...
  ::sendto(send_socket_fd, &send_udp_buffer, BYTES_PER_PACKET - 1, 0, (sockaddr*)&server_address,
           sizeof(server_address));
  ...
  ASSERT_TRUE(udp_receiver.receive(&recv_udp_buffer, BYTES_PER_PACKET - 1));
