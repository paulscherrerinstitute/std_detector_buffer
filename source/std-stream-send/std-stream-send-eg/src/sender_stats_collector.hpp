...
#ifndef STD_DETECTOR_BUFFER_SENDER_STATS_COLLECTOR_EG_HPP
#define STD_DETECTOR_BUFFER_SENDER_STATS_COLLECTOR_EG_HPP
...
public:
  explicit SenderStatsCollector(std::string_view detector_name, int part)
      : utils::StatsCollector<SenderStatsCollector>("std_stream_send_eg", detector_name)
      , image_part(part)
  {}
...
#endif // STD_DETECTOR_BUFFER_SENDER_STATS_COLLECTOR_EG_HPP
